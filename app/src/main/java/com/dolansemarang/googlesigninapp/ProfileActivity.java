package com.dolansemarang.googlesigninapp;
        ...
        Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>() {
            ...
            public void onResult(@NonNull Status status) {
                if(status.isSuccess()){
                    ...
                    Toast.makeText(getApplicationContext(),"Session is not close", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        if(result.isSuccess()){
            ...
            try{
                ...
                Toast.makeText(getApplicationContext(), "imageNotFound", Toast.LENGTH_LONG).show();
            }
        }
        else{
            gotoMainActivity();
